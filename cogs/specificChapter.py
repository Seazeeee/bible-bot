...
class specificChapter():


    def __init__(self, book: str, chapter: int, translation = None):
    ...
    def pullVerse(self):
        ...
        bookId = exact_match
        # https://bolls.life/get-chapter/<slug:translation>/<int:book>/<int:chapter>/

        url = "https://bolls.life/get-chapter/"+ str(self.translation) + "/" + str(bookId) + "/" + str(self.chapter) + "/"
        chapter_url = "https://bolls.life/"+ str(self.translation) + "/" + str(bookId) + "/" + str(self.chapter) + "/" 
