...
def Main():
    ...
    async def slash_command(
        ...
        await interaction.response.send_message(
            ":pray: " + specificVerse(book, chapter, verse, translation).pullVerse()
        )
    ...
    async def slash_command(
        ...
        await interaction.response.send_message(
            ":pray: " + specificChapter(book, chapter, translation).pullVerse()
        )

    @bot.tree.command(name="versus", description="Specified versus.")
    @commands.has_permissions(administrator=True)
    async def slash_command(
        interaction: discord.Interaction,
        book: str,
